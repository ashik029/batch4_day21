            ...
            <div class="col-md-8 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-capitalize">OddEven</h3>
                        <div class="card-body">
                            <form action="action.php" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <label for=""><input type="radio"  value="+" name="option">odd</label>
                                        <label for=""><input type="radio"  value="-" name="option">even</label>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="" class="col-md-4 col-form-label"></label>
                                    <div class="col-md-8">
                                        <input type="submit" name="odd-btn" class="btn-outline-success btn-block" value="show result">
                                    </div>
                                </div>
                        </div>
                        </form>
